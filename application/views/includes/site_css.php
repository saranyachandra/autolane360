...
<html lang="en">
  ...
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url('assets/images/banner/favicon.png')?>" />
  <!-- Vendor CSS
  ============================================ -->
  
  <link rel="stylesheet" href="<?php echo base_url('assets/font/demo-files/demo.css');?>">
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/admin-assets/css/magnific-popup.css');?>">
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/smart_wizard_theme_circles.css');?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/css/smart_wizard_theme_dots.css');?>">
