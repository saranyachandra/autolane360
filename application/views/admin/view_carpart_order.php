                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <select name="category" class="carpart_status form-control">
                              <option  value="pending" <?php if(isset($details->status) && ($details->status == "pending" )){ echo "selected"; } else { echo ""; } ?> >Pending </option>
                              <option value="booking" <?php if(isset($details->status) && ($details->status == "booking" )){ echo "selected"; } else { echo ""; } ?> >Booking </option>
                              <option value="approved" <?php if(isset($details->status) && ($details->status == "approved" )){ echo "selected"; } else { echo ""; } ?> >Approved </option>
                            </select>
                          </td>
                          <td>
