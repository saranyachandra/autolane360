                                                        ...
                                                        <div class="tab-pane active" id="USA">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $details->cus_country;?></td>
                                                                        <td><?php echo $details->referral_code;?></td>
                                                                        <td>
                                                                          <a class="btn btn-info" href="<?php echo base_url('admin/all_customer_view_details/'.$details->agent_cus_id); ?>"> View </a> 
                                                                          <a class="btn btn-danger delete_customer" style="padding: 5px;" href="<?php echo base_url('admin/agent_delete_customer/'.$details->agent_cus_id); ?>" >
                                                                                delete
                                                                          </a>
                                                                        </td>
