            ...
            <main class="main-wrapper clearfix">
                ...
                <div class="row page-title clearfix">
                    <div class="page-title-left">
                        ...
                        <p class="page-title-description mr-0 d-none d-md-inline-block">Customer Car Details</p>
                    </div>
                    <!-- /.page-title-left -->
                                                                ...
                                                                <table class="table table-responsive">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td> 
                                                                            ...
                                                                            <a class="btn btn-info" style="padding: 5px;" href="<?php echo base_url('admin/car_sale_invoice_details/'.$details->carstock_id); ?>" >
                                                                                Edit
                                                                            </a>
                                                                            <a class="btn btn-danger " style="padding: 5px;" href="#" >
                                                                                delete
                                                                            </a>
                                                                        </td> -->
