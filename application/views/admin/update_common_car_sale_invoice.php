                        ...
                        <div class="widget-bg">
                                ...
                                <div class="row">
                                   <div class="col-sm-6 col-md-6" >
                                        <div class="row" style="margin-top:20px;">
                                            <span>Car Type: </span>
                                            <p><?php echo $car_info->car_type; ?></p>
                                        </div>
                                        <div class="row">
                                            <span>Car Year:</span>
                            ...
                            <div class="row">
                                <div class="col-md-12 widget-holder" style="margin-top: 25px;">
                                    <form id="update_invoice_form" action="<?php echo base_url('admin/update_common_car_invoice'); ?>" method="POST" enctype="multipart/form-data"> 
                                        <input type="hidden" name="car_booking_id" value="<?php echo $car_info->car_booking_id; ?>">
                                        <div class="container">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="invoice_date" id="invoice_date" class="form-control" value="<?php echo $car_info->invoice_date;  ?>" autocomplete="off">
                                                </div>

                                                <div class="col-md-4">
                                                    <span>Due Date</span>
                                                    <input type="text" name="due_date"  id="due_date" class="form-control" value="<?php echo $car_info->due_date;  ?>" autocomplete="off">
                                                </div>
