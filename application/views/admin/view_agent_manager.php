            ...
            <main class="main-wrapper clearfix">
                ...
                <div class="row page-title clearfix">
                    <div class="page-title-left">
                        ...
                        <p class="page-title-description mr-0 d-none d-md-inline-block">Information about Agent details</p>
                    </div>
                    <!-- /.page-title-left -->
                                        ...
                                        <div class="widget-body clearfix">
                                                        ...
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="USA">
                                                                    <table class="table edit_table table-responsive">
                                                                            ...
                                                                            <tbody>
                                                <?php 
                                                    foreach ($agent_user_detail as  $user_details) {
                                                ...
                                                ?>    
                                                    <tr>
                                                        ...
                                                        <td><?php echo $user_details->admin_password;?></td>
                                                        <td>
                                                            <?php echo $user_details->delegate;?>
                                                        </td>
                                                        <td>
                                                            <select class="form-control" >
                                                                <option value="1" <?php if(isset($user_details->Active) && ($user_details->Active == "1" )){ echo "selected"; } else { echo ""; } ?> >Active</option>
