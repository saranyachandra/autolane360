            ...
            <main class="main-wrapper clearfix">
                ...
                <div class="row page-title clearfix">
                    <div class="page-title-left">
                        <h6 class="page-title-heading mr-0 mr-r-5">Add Admin Members</h6>
                    ...
                    <div class="page-title-right d-none d-sm-inline-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add Admin Members</li>
                        </ol>
                    </div>
                    <!-- /.page-title-right -->
                </div>
                        ...
                        <div class="widget-bg">
                            ...
                            <div class="row">
                                <div class="col-md-12 widget-holder" style="margin-top: 25px;">
                                    <form id="admin_form" action="<?php echo base_url('admin/insert_admin_user'); ?>" method="POST" enctype="multipart/form-data"> 
                                        <div class="container">
            ...
            $.ajax({
                    ...
                    success: function(response)
                    {
                       if(response.status == 'success')
                       {
                        ...
                        document.getElementById("admin_form").reset(); //clear form data
                         window.location.href = "<?php echo base_url('admin/view_admin_manager'); ?>";
