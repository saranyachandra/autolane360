                            ...
                            <div class="widget-body clearfix">
                                <div class="tabs">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#USA" data-toggle="tab" aria-expanded="true">Agent Invoice</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#Nigeria" data-toggle="tab" aria-expanded="true">agent List Invoice</a>
                                        </li>
                                    </ul>
                                       <!-- /.nav-tabs -->
                                        ...
                                        <div class="tab-pane active" id="USA">
                                            <table class="table table-responsive">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $details->order_ticket;?></td>
                                                        <td><?php echo $details->f_name." ".$details->l_name;?> </td>
                                                        <td><?php echo $details->phone_no." / ".$details->email;?> </td>
                                                        <td>
                                                            <?php echo $details->car_year." ".$details->car_brand." ".$details->car_model;?>
                                                        </td>
                                                        <td><?php echo $details->price;?></td>
                                                        <td>
                                                            <?php echo $details->customer_status;?>
                                                        </td>
                                                        <td> 
                                                            <a class="btn btn-info" style="padding: 5px;" href="<?php echo base_url('admin/car_sale_invoice_details/'.$details->carstock_id); ?>" >Edit </a>
                                                            <a class="btn btn-danger " style="padding: 5px;" href="#" >delete </a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
                                        ...
                                        <div class="tab-pane" id="Nigeria">
                                            <table class="table table-responsive">
                                                ...
                                                <tbody>
                                                    <?php 
                                                        $i = 1;
                                                        foreach ($agent_list_cus_detail as $details) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $details->f_name." ".$details->l_name;?> </td>
                                                        ...
                                                        <td><?php echo $details->price;?></td>
                                                        <td>
                                                            <?php echo $details->car_booking_status;?>
                                                        </td>
                                                        <td> 
                                                            <a class="btn btn-info" style="padding: 5px;" href="<?php echo base_url('admin/common_car_sale_invoice_details/'.$details->car_booking_id); ?>" >
                                                                                Edit
                                                            </a>
                                                            <a class="btn btn-danger " style="padding: 5px;" href="#" >delete</a>
                                                        </td>
