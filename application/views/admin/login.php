    ...
    <div id="wrapper" class="row wrapper">
        <div class="container-min-full-height d-flex justify-content-center align-items-center">
            <div class="login-center">
                ...
                <!-- /.navbar-header -->
                <form id="login_form" action="<?php echo base_url('Admin_login/sadmin_login_auth'); ?>"  method="POST" enctype="multipart/form-data">
                     <div id="result"></div>
                    ...
                    <div class="form-group no-gutters mb-0">
                        <div class="col-md-12 d-flex">
                            <a href="<?php echo base_url('admin_login/forget_password');?>" id="to-recover" class="my-auto pb-2 text-right">
