                            ...
                            <div class="widget-body clearfix">
                                <div class="tabs">
                                    ...
                                    <div class="tab-content">                                       
                                            <table id="table_view" class="table table-responsive" style="width: 100%;">
                                                <thead>
                                                    <tr>                                                      
                                                        ...
                                                        foreach ($detail as $key => $value) {  
                                                            ...
                                                            foreach ($value as $details) {
                                                               ...
                                                               echo 
                                                                ...
                                                                if($i == 0)
                                                                echo   '<td rowspan="'.count($value).'">'.$details['f_name']." ".$details['l_name'].'</td>';
                                                              
                                                                echo' 
                                                                    <td style="display:none;"></td>
                                                                    <td><img style="height: 50px; width: 50px;" src='.$details['admincar_stockimg'].' class="img-responsive" /></td>
                                                                    <td>'.$details['car_number'].'</td>
                                                                    <td style="text-transform:capitalize;">'.$details['car_year']." ".$details['car_brand'].$details['car_model'].'</td>
                                                                    <td>'.$details['price'].'</td>
                                                                    <td>'.$details['customer_status'].'</td>
                                                                    <td>
                                                                    <a class="btn btn-info" style="padding: 5px;" href="'.base_url('admin/view_agent_car_info_details/').$details['carstock_id'].'" >View </a>
