                                                            ...
                                                            <div class="tab-pane active" id="USA">
                                                                <table class="table table-editable table-responsive">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                           <?php echo $car_details->customer_status;?>
                                                                            
                                                                        </td>

                                                                        <td> 
                                                                           <a class="btn btn-info" style="padding: 5px;" href="<?php echo base_url('admin/edit_common_agent_carstock/'.$car_details->carstock_id); ?>" >
                                                                                Edit
                                                                            </a>
                                                                            <a class="btn btn-danger delete_carstock" style="padding: 5px;" href="<?php echo base_url('admin/delete_common_agent_car/'.$car_details->carstock_id); ?>" >
                                                                                delete
                                                                            </a>
                                                                        </td>
            ...
            if(result)
               {
                  ...
                  $.ajax({
                          ...
                          success: function(response) 
                          {
                             ...
                             {
                                swal("Carstock Deleted Successfully...")
