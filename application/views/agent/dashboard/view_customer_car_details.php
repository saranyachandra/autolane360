                                                            ...
                                                            foreach ($value as $details) {
                                                               ...
                                                               echo 
                                                                ...
                                                                echo' 
                                                                    ...
                                                                    <td>'.$details['order_ticket'].'</td>
                                                                    <td>'.$details['car_number'].'</td>
                                                                    <td>'.$details['phone_no']." / ".$details['email'].'</td>
                                                                    <td>'.$details['car_year']." ".$details['car_brand']." ".$details['car_model'].'</td>
                                                                    <td>'.$details['price'].'</td>
                                                                    <td>'.$details['customer_status'].'</td>
                                                                    <td><a class="btn btn-danger" style="padding: 5px;" href="#" >delete  </a></td>
                                                                   </tr>
